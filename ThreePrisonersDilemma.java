...
public class ThreePrisonersDilemma {
	...
	class Agrawal_Rachita_Player extends Player {
		...
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			...
			// Rule 3
			// Hard Tit for Tat Player: Check if opponent has defected on any of the previous 2 moves, if true defect, else cooperate
...
//	This is a helper function needed by scoresOfMatch.
	...
	Player makePlayer(int which) {
		...
		case 6: return new Agrawal_Rachita_Player();
		}
	...
	void runTournament() {
		...
		try{
		FileWriter csvWriter = new FileWriter("Final_Score.csv");
		for (int i=0; i<numPlayers; ++i) {
